function connectCopyButton() {
    // Get the <pre> element
    const preTag = document.getElementById("code--connect");
...
function favoriteCopyButton() {
    // Get the <pre> element
    const preTag = document.getElementById("code--favorite");
